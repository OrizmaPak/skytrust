...
const saveTransactionMiddleware = async (req, res, next) => {
    ...
    try {
        ...
        //      const savingsAccountQuery = `SELECT * FROM skytobi."savings" WHERE accountnumber = $1`;
        ...
        //      whichaccount = 'LOAN';
        //      const loanAccountQuery = `SELECT * FROM skytobi."loanaccounts" WHERE accountnumber = $1`;
        ...
        //      whichaccount = 'ROTARY';
        //      const rotaryAccountQuery = `SELECT * FROM skytobi."rotaryaccount" WHERE accountnumber = $1`;
        ...
        //      const propertyAccountQuery = `SELECT * FROM skytobi."propertyaccount" WHERE accountnumber = $1`;
        ...
        //      const glAccountQuery = `SELECT * FROM skytobi."Accounts" WHERE accountnumber = $1`;
        ...
        if (accountResult.rowCount !== 0) {
            ...
            const userQuery = `SELECT * FROM skytobi."User" WHERE phone = $1::text`;
            const userResult = await client.query(userQuery, [phoneNumber]);
            if (userResult.rowCount === 0) {
                // If not found in User table, check the Supplier table
                const supplierQuery = `SELECT * FROM skytobi."Supplier" WHERE contactpersonphone = $1`;
        ...
        if (accountResult.rowCount) {
            const userQuery = `SELECT phone FROM skytobi."User" WHERE id = $1`;
        ...
        if (loanAccountResult.rowCount) {
            const loanUserQuery = `SELECT phone FROM skytobi."User" WHERE id = $1`;
        ...
        if (propertyAccountResult.rowCount) {
            const propertyUserQuery = `SELECT phone FROM skytobi."User" WHERE id = $1`;
        ...
        if (rotaryAccountResult.rowCount) {
            const rotaryUserQuery = `SELECT phone FROM skytobi."User" WHERE id = $1`;
        ...
        const rejectTransactionDateQuery = `SELECT * FROM skytobi."Rejecttransactiondate" WHERE rejectiondate = $1`;
        ...
        if (whichaccount === 'SAVINGS') {            
            ...
            const frequencyOverrideQuery = `
                SELECT * FROM skytobi."frequencyoverride" 
