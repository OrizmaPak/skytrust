    ...
    if (credit > 0) { 
        ...
        if (savingsProduct.compulsorydeposit) {
            ...
            const lastTransactionQuery = `
                SELECT * FROM skytobi."transaction"
                WHERE accountnumber = $1 AND status = 'ACTIVE'
        ...
        //     INSERT INTO skytobi."transaction" (accountnumber, credit, reference, description, ttype, status, valuedate, whichaccount) 
        ...
        //     await client.query(
        //         `INSERT INTO skytobi."transaction" (accountnumber, debit, description, reference, status, whichaccount) VALUES ($1, $2, $3, $4, 'PENDING', $5)`,
        ...
        //     await client.query(
        //         `UPDATE skytobi."transaction" SET tax = $1 WHERE reference = $2`,
