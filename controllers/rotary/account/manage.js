    ...
    const createOrUpdateRotaryAccount = async (req, res) => {
        ...
        const productQuery = `SELECT * FROM skytobi."rotaryProduct" WHERE id = $1`;
        ...
        try {
            ...
            if (!accountnumber) {
                ...
                const accountRowsQuery = `SELECT accountnumber FROM skytobi."rotaryaccount" WHERE accountnumber::text LIKE $1 ORDER BY accountnumber DESC LIMIT 1`;
            ...
            if (accountnumber) {
                ...
                query = {
                    text: `UPDATE skytobi."rotaryaccount" 
                ...
                query = {
                    text: `INSERT INTO skytobi."rotaryaccount" 
            ...
            const scheduleQuery = {
                text: `SELECT * FROM skytobi."rotaryschedule" WHERE accountnumber = $1 AND currentschedule = 'YES'`,
            ...
            if (existingSchedules.length > 0) {
                ...
                const deleteScheduleQuery = {
                    text: `DELETE FROM skytobi."rotaryschedule" 
                ...
                for (const date of nextDates) {
                    ...
                    const insertScheduleQuery = {
                        text: `INSERT INTO skytobi."rotaryschedule" 
            ...
            if (poolNumber === 'SEQUENCE') {
                ...
                const maxScheduleQuery = {
                    text: `SELECT MAX(duedate) as maxduedate FROM skytobi."rotaryschedule" WHERE accountnumber = $1`,
                    values: [generatedAccountNumber]
                };
                const { rows: [{ maxduedate }] } = await pg.query(maxScheduleQuery);
                const totalAmountQuery = {
                    text: `SELECT SUM(amount) as totalamount FROM skytobi."rotaryschedule" WHERE accountnumber = $1`,
                    values: [generatedAccountNumber]
                };
                ...
                const randomScheduleQuery = {
                    text: `SELECT duedate FROM skytobi."rotaryschedule" WHERE accountnumber = $1 ORDER BY RANDOM() LIMIT 1`,
                    values: [generatedAccountNumber]
                };
