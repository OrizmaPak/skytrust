    ...
    const getAccountsAndSchedules = async (req, res) => {
        ...
        try {
            ...
            let query = {
                text: `SELECT * FROM skytobi."rotaryaccount"`,
                values: []
            };
            ...
            const countQuery = {
                text: `SELECT COUNT(*) FROM skytobi."rotaryaccount" ${whereClause}`,
            ...
            const processedAccounts = await Promise.all(accounts.map(async (account) => {
                ...
                const userQuery = {
                    text: `SELECT firstname, lastname, othernames FROM skytobi."User" WHERE id = $1`,
                    values: [userId]
                };
                ...
                const registrationPointQuery = {
                    text: `SELECT registrationpoint AS name FROM skytobi."Registrationpoint" WHERE id = $1`,
                ...
                // Fetch product name
                const productQuery = {
                    text: `SELECT product AS productname FROM skytobi."rotaryProduct" WHERE id = $1`,
                    values: [productId]
                };
                ...
                // Fetch member name
                const memberQuery = {
                    text: `SELECT member AS membername FROM skytobi."DefineMember" WHERE id = $1`,
                    values: [memberId]
                };
                ...
                // Fetch branch name
                const branchQuery = {
                    text: `SELECT branch AS branchname FROM skytobi."Branch" WHERE id = $1`,
                    values: [branchId]
                };
                ...
                const scheduleQuery = {
                    text: `
                        SELECT * FROM skytobi."rotaryschedule" 
