...
const saveOrUpdatePropertyProduct = async (req, res) => {
    ...
    try {
        ...
        if (id) {
            ...
            const updateQuery = {
                text: `UPDATE skytobi."propertyproduct" 
            ...
            const insertQuery = {
                text: `INSERT INTO skytobi."propertyproduct" (product, member, useraccount, registrationcharge, createdby, productofficer, currency, description, dateadded, status) 
