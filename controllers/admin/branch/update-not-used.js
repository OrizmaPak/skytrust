...
const updatebranch = async (req, res) => {
    ...
    try{
        ...
        if(branch){
            const {rows:checkname} = await pg.query(`SELECT branch FROM skytobi."Budget" WHERE branch = $1`, [branch]);
            ...
            const {rowCount: updatelocation} = await pg.query(`UPDATE skytobi."Budget" 
