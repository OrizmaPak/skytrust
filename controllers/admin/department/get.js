...
const getDepartment = async (req, res) => {
    try {
        ...
        let queryString = `
            ...
            FROM skytobi."Department" d
            LEFT JOIN skytobi."Branch" b ON d.branch = b.id
            LEFT JOIN skytobi."User" u ON d.userid = u.id
            WHERE 1=1
        ...
        let countQuery = `SELECT COUNT(*) FROM skytobi."Department" d WHERE 1=1`;
        let countParams = [];
        if (branch) {
