...
const manageMembership = async (req, res) => {
    ...
    try {
        ...
        const { rows: existingMembership } = await pg.query(
            `SELECT * FROM skytobi."Membership" WHERE member = $1 AND userid = $2`,
            [member, userid]
        );
        ...
        if (id) {
            query = await pg.query(`UPDATE skytobi."Membership" SET 
            ...
            query = await pg.query(`INSERT INTO skytobi."Membership" 
