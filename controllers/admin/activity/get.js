...
const getActivity = async (req, res) => {
    ...
    try {
        ...
        let {rows: alluser} = await pg.query(`SELECT u.id, u.firstname, u.lastname, u.othernames, u.phone, u.country AS usercountry, b.branch AS branchname, b.country AS branchcountry, b.state AS branchstate, b.lga AS branchlga, b.address AS branchaddress FROM skytobi."User" u LEFT JOIN skytobi."Branch" b ON u.branch = b.id`)
