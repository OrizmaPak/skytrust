...
const getFrequencyOverrides = async (req, res) => {
    ...
    try {
        ...
        const countQuery = {
            text: `SELECT COUNT(*) FROM skytobi."frequencyoverride" ${whereClause}`,
