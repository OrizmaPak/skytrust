...
const manageissuelog = async (req, res) => {
    ...
    try {
        ...
        for (let i = 0; i < rowsize; i++) {
            ...
            await pg.query(`INSERT INTO sky."Inventory" (itemid, branch, department, qty, status, transactiondesc, dateadded, createdby, itemname, units, cost, price, pricetwo, beginbalance, minimumbalance, "group", applyto, itemclass, composite, compositeid, description, imageone, imagetwo, imagethree, sellingprice, reference, transactiondate, issue, issuetype) 
