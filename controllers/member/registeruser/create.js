...
const registeruser = async (req, res) => {
    ...
    try {
        ...
        if (id) {
            ...
            const { rows: existingUser } = await pg.query(`SELECT * FROM skytobi."User" WHERE id = $1`, [id]);
            ...
            const { rows: updatedUser } = await pg.query(`UPDATE skytobi."User" SET 
            ...
            const { rows: [saveuser] } = await pg.query(`INSERT INTO skytobi."User" 
