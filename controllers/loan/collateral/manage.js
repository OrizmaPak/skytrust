...
async function addOrUpdateCollateral(req, res) {
    ...
    try {
        if (id) {
            ...
            const existingCollateralQuery = `SELECT * FROM skytobi."collateral" WHERE id = $1`;
            ...
            if (documentnumber || docposition) {
                const existingDocumentQuery = `
                    SELECT * FROM skytobi."collateral" 
            ...
            // Uncomment if needed
            /*
            const accountCheck = await pg.query(`SELECT * FROM skytobi."loanaccounts" WHERE accountnumber = $1`, [accountnumber]);
            ...
            */
            ...
            const insertCollateralQuery = `
                INSERT INTO skytobi."collateral" (
                    accountnumber, 
                    documenttitle, 
                    documentnumber, 
                    description, 
