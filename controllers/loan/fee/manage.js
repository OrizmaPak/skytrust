...
const manageLoanFee = async (req, res) => {
    ...
    try {
        ...
        const accountExistsQuery = {
            text: 'SELECT * FROM skytobi."Accounts" WHERE accountnumber = $1',
            values: [glaccount]
        };
        ...
        if (id) {
            ...
            const updateLoanFeeQuery = {
                text: `UPDATE skytobi."loanfee" SET 
            ...
            const feenameExistsQuery = {
                text: 'SELECT * FROM skytobi."loanfee" WHERE feename = $1',
                values: [feename]
            };
            ...
            const createLoanFeeQuery = {
                text: `INSERT INTO skytobi."loanfee" (feename, feemethod, chargesbasedon, chargeamount, chargetype, glaccount, status, dateadded, createdby) VALUES ($1, $2, $3, $4, $5, $6, $7, NOW(), $8) RETURNING *`,
