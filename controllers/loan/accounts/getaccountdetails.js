...
const getLoanAccountDetails = async (req, res) => {
    ...
    try {
        ...
        const loanAccountQuery = {
            text: `SELECT * FROM skytobi."loanaccounts" WHERE accountnumber = $1`,
        ...
        const transactionsQuery = {
            text: `SELECT * FROM skytobi."transaction" WHERE accountnumber = $1 AND status = 'ACTIVE'`,
            values: [accountnumber]
        };
        ...
        if (loanAccount.defaultpenaltyid) {
            const penaltyQuery = {
                text: `SELECT * FROM skytobi."loanfee" WHERE id = $1`,
