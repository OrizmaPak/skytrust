...
const updateDisbursementRef = async (req, res) => {
    ...
    try {
        ...
        //     text: `SELECT loanproduct, registrationcharge FROM skytobi."loanaccounts" WHERE accountnumber = $1`,
        ...
        //     text: `SELECT addition_loan_registration_charge FROM skytobi."Organisationsettings" WHERE loanproduct = $1`,
        //     values: [loanproduct]
        // };
        ...
        const updateQuery = {
            text: `UPDATE skytobi."loanaccounts" SET disbursementref = $1, disbursementdate = NOW() WHERE accountnumber = $2`,
