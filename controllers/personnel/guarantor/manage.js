...
const saveOrUpdateGuarantor = async (req, res) => {
    ...
    try {
        ...
        const { rows: userRows } = await pg.query(
            `SELECT id FROM skytobi."User" WHERE id = $1`,
            [userid]
        );
        ...
        if (id) {
            ...
            const { rows } = await pg.query(
                `INSERT INTO skytobi."guarantor" (userid, guarantorname, guarantorofficeaddress, guarantorresidentialaddress, guarantoroccupation, guarantorphone, yearsknown, imageone, imagetwo, dateadded, createdby, status) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9, NOW(), $10, 'ACTIVE') RETURNING id`,
