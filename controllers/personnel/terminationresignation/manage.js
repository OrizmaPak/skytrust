...
const saveOrUpdateTerminationResignation = async (req, res) => {
    ...
    try {
        ...
        if (id) {
            ...
            query = {
                text: `UPDATE skytobi."terminationresignation" 
            ...
            // Insert new record
            query = {
                text: `INSERT INTO skytobi."terminationresignation" (userid, title, type, image, createdby, status)
        ...
        const updateUserRoleQuery = {
            text: `UPDATE skytobi."User" SET role = $1 WHERE id = $2`,
