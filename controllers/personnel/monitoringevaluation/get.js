    ...
    try {
        let query = {
            text: `
                ...
                FROM skytobi."monitoringevaluation" me
                JOIN skytobi."User" u ON me.userid = u.id
        ...
        const countQuery = {
            text: `SELECT COUNT(*) FROM skytobi."monitoringevaluation" WHERE status = 'ACTIVE' ${whereClause}`,
