...
const saveOrUpdateEmploymentRecord = async (req, res) => {
    ...
    try {
        ...
        if (id) {
            ...
            await pg.query(
                `UPDATE skytobi."employmentrecord" SET 
            ...
            const { rows } = await pg.query(
                `INSERT INTO skytobi."employmentrecord" (userid, employer, position, years, reasonofleaving, doc, dateadded, createdby, status) VALUES ($1, $2, $3, $4, $5, $6, NOW(), $7, 'ACTIVE') RETURNING id`,
